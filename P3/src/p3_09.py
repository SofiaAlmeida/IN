...
print("------ RandomForest...")
rf = RandomForestClassifier(n_jobs=-1, random_state = 123456, max_depth = 40, n_estimators = 500, max_features = 'sqrt')
# class_weight = balanced
#params_rf = {'max_depth':[20], 'n_estimators':[300], 'class_weight':['balanced']} # 'warm_start':[True, False]
