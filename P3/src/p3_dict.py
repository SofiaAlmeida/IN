...
def preprocessing(data_x, data_x_tst):
    ...
    data_x_tmp = data_x.to_dict(orient='records')
    dv_x = DictVectorizer(sparse = False)
    data_x_tmp = dv_x.fit_transform(data_x_tmp)

    print("Nº variables tras DictVectorizer: " + str(data_x_tmp.shape[1]))
    ...
    data_x_tmp = data_x_tst.to_dict(orient='records')
    data_x_tmp = dv_x.fit_transform(data_x_tmp)
