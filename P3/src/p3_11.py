...
print("------ LightGBM...")
lgbm = lgb.LGBMClassifier(objective='regression_l1', n_jobs=-1, scale_pos_weight = 0.1)
params_lgbm = {'learning_rate':[0.1],
               'num_leaves':[45, 50, 55], 'n_estimators':[200, 300, 400, 500]}
