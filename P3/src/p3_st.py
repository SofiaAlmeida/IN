...
estimators = [
    ('lgbm', lgb.LGBMClassifier(objective='regression_l1', n_estimators=1000, num_leaves = 80, scale_pos_weight = 0.05, verbose = 2)),
    ('rf', RandomForestClassifier(random_state = 123456, max_depth = 20, n_estimators = 300, verbose = 2)),
