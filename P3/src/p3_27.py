...
estimators = [
    ...
    ('rf', RandomForestClassifier(random_state = 123456, n_jobs = -1, max_depth = 60, n_estimators = 450, verbose = 2)),
    ('xgboost', xgb.XGBClassifier(predictor='cpu_predictor', n_gpus=0, n_jobs = -1, n_estimators = 800, eta = 0.1, max_depth = 10, verbose=2))]
