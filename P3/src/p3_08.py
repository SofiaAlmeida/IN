...
params_rf = {'max_depth':[20], 'n_estimators':[300], 'class_weight':['balanced', {1:0.6, 2:0.1, 3:0.3}, {1:0.65, 2:0.1, 3:0.25}, {1:0.55, 2:0.1, 3: 0.}], 'max_features':['sqrt']} # 'warm_start':[True, False]
